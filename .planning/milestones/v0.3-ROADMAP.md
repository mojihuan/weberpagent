...
- [x] 10-04: 完整执行销售出库用例 (推迟到 v0.3.1 - 需要原生 ERP API)
### Phase 11: Bug 修复
...
*Last updated: 2026-03-18 - v0.2.1 和 v0.3 milestone complete*
