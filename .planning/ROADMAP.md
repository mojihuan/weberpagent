...
- [x] **Phase 52: Prompt 增强 — 键盘操作** — 扩展 ENHANCED_SYSTEM_MESSAGE 添加键盘操作指导，Agent 能执行 Control+a 全选覆盖、Enter 搜索触发、Escape 关闭弹窗 (completed 2026-03-30)
...
|-------|-----------|----------------|--------|-----------|
| 52. Prompt 增强 — 键盘操作 | v0.7.0 | 2/2 | Complete   | 2026-03-30 |
